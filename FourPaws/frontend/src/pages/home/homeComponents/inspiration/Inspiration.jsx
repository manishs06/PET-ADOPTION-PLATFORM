...
const Inspiration = () => {
    return (
        <div className=' flex justify-center flex-col mx-auto items-center w-8/12 mb-12'>
...
<p>At FourPaws, we believe in the transformative power of pet adoption. Each day, countless animals are patiently waiting for their forever homes, and we invite you to be a part of their incredible journey.</p>
            </div>
            <div>
